      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="w-[450px] h-[50px] p-5 h7 text-SecondaryTextColor rounded-md border border-black"
        ...
        <div className="">
          <div className="flex w-[450px] h7 rounded-md h-[50px] text-SecondaryTextColor">
            <label className="w-10/12 p-5 flex items-center border border-black">Role</label>
            <select
              className="border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-500 border border-black"
              {...register("role_id", {
        ...
        {selectedRole === "store" && (
          <>
            <div className="flex flex-col gap-2">
              ...
              <span
                className={`px-5 h8 text-SecondaryTextColor max-w-[450px] ${
                  errors.storeName ? "text-red-700" : "hidden"
                }`}
              >
            ...
            <div className="flex flex-col gap-2">
              ...
              <span
                className={`px-5 h8 text-SecondaryTextColor max-w-[450px] ${
                  errors.storePhone ? "text-red-700" : "hidden"
                }`}
              >
            ...
            <div className="flex flex-col gap-2">
              ...
              <span
                className={`px-5 h8 text-SecondaryTextColor max-w-[450px] ${
                  errors.storeTaxNo ? "text-red-700" : "hidden"
                }`}
              >
            ...
            <div className="flex flex-col gap-2">
              ...
              <span
                className={`px-5 h8 text-SecondaryTextColor max-w-[450px] ${
                  errors.storeBankAccount ? "text-red-700" : "hidden"
                }`}
              >
